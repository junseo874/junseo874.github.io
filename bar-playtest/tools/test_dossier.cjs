...
(async()=>{let browser;try{
 ...
 await p.locator('[data-act="dossierOpen"]').click();
 ...
 await p.locator('[data-act="dossierOpen"]').click();assert.equal(await p.locator('.guest-card[data-id="shiba"] .filled').count(),1);
 ...
 await p.keyboard.press('Escape');await p.evaluate(()=>{barGame.lang='en';});await p.locator('[data-act="dossierOpen"]').click();
